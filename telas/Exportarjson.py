...
def exportar(arquivo, dados):
  with open(f'{arquivo}.json', 'w') as json_file:
        json.dump(dados, json_file, indent=4)

def zipar():
  z = zipfile.ZipFile(f'Arquivos_{data}.zip', 'w', zipfile.ZIP_DEFLATED)
  z.write(exportar('Frotas', frotas))
  z.write(exportar('Reservas', reservas))
  z.write(exportar('Clientes', clientes))